-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'ANALISTA', 'USER');
...
CREATE TABLE "Lead" (
    ...
    "telefoneEnc" TEXT NOT NULL,
    "vinSharePseudo" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "Lead_retainUntil_idx" ON "Lead"("retainUntil");
